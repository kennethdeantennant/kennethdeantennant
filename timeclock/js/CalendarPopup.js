...
function CalendarPopup_getCalendar() {
	...
	if (this.type == "WINDOW") {
		...
		result += '<TABLE WIDTH=144 BORDER=1 BORDERWIDTH=1 BORDERCOLOR="#000000" CELLSPACING=0 CELLPADDING=1>\n';
	...
	if (this.displayType=="date" || this.displayType=="week-end") {
		...
		if (this.isShowYearNavigation) {
			...
			result += td + ' WIDTH=10><B><A CLASS="cal" HREF="../../frzrtime/js/'+refresh+'('+this.index+','+last_month+','+last_month_year+');"><</A></B></TD>';
			result += td + ' WIDTH=58>'+this.monthNames[month-1]+'</TD>';
			result += td + ' WIDTH=10><B><A CLASS="cal" HREF="../../frzrtime/js/'+refresh+'('+this.index+','+next_month+','+next_month_year+');">></A></B></TD>';
			result += td + ' WIDTH=10> </TD>';
			result += td + ' WIDTH=10><B><A CLASS="cal" HREF="../../frzrtime/js/'+refresh+'('+this.index+','+month+','+(year-1)+');"><</A></B></TD>';
			result += td + ' WIDTH=36>'+year+'</TD>';
			result += td + ' WIDTH=10><B><A CLASS="cal" HREF="../../frzrtime/js/'+refresh+'('+this.index+','+month+','+(year+1)+');">></A></B></TD>';
			}
		else {
			result += '	<TD BGCOLOR="#C0C0C0" CLASS="cal" WIDTH=22 ALIGN=CENTER VALIGN=MIDDLE><B><A CLASS="cal" HREF="../../frzrtime/js/'+refresh+'('+this.index+','+last_month+','+last_month_year+');"><<</A></B></TD>\n';
			result += '	<TD BGCOLOR="#C0C0C0" CLASS="cal" WIDTH=100 ALIGN=CENTER>'+this.monthNames[month-1]+' '+year+'</TD>\n';
			result += '	<TD BGCOLOR="#C0C0C0" CLASS="cal" WIDTH=22 ALIGN=CENTER VALIGN=MIDDLE><B><A CLASS="cal" HREF="../../frzrtime/js/'+refresh+'('+this.index+','+next_month+','+next_month_year+');">>></A></B></TD>\n';
			}
		result += '</TR></TABLE>\n';
		...
		result += '</TR>\n';
		result += '<TR><TD COLSPAN=7 ALIGN=CENTER><IMG SRC="../../frzrtime/js/graypixel.gif" WIDTH=120 HEIGHT=1></TD></TR>\n';
