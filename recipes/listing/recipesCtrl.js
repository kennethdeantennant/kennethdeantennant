...
app.controller('recipesController', ['$scope', '$location', '$http', '$routeParams', '$filter', 'recipesService', 'sessionService', function ($scope, $location, $http, $routeParams, $filter, recipesService, sessionService) {
    ...
    $scope.categories = [];
    recipesService.retrieveCategories($scope);    
    
    $scope.recipes = [];
    recipesService.retrieveRecipes($scope);
    
    $scope.details = [];
    recipesService.retreieveRecipeDetails($scope);
    ...
    $scope.addCategory = function(){
        ...
        recipesService.createCategory(data, $scope);
        $scope.newCategory = "";
    }
    
    $scope.deleteCategory = function( value ){
        var data = {category_id: value}
        recipesService.deleteCategory(data, $scope);        
    }
}])
