...
<div id="pagecell1">
  ...
  <div id="pageName">
    <h2>Elizabeth Jane</h2></div>
  <div id="pageNav">
    
    <div class="relatedLinks">
      <h3>Page Links </h3>
    <a href="https://sites.google.com/site/agapebirthserviceandcenter/" class="side" target="_blank" title="Located in Pocatello Idaho">Agape Birth Services</a></div>
    <div id="advert">
  ...
  <div id="content">
    <div class="feature">
      <p>
	<?php $pictures->load(38); ?>
    <img src='../images/<?php echo($pictures->getName()); ?>' alt=''>
      </p>
      <p><strong>Elizabeth Jane</strong> just recently joined the family. She came the same way as the last two born at home in Pocatello, Idaho. Because she is such a recent edition, no picture or other information can be added at this time. However, this should change in the coming weeks as this new life has brought joy again into the home. The one thing the parents did to keep this birth exciting, though, was that they did not find out what the gender would be until the birth. What a rush for the parents to learn on that day wether they were getting a new little girl or boy.</p>
<p>&nbsp;</p>
    </div>
    <div class="story"></div>
  </div>
