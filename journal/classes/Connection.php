<?php // This is the connection class
    class Connection{

        private	$dbHost = "localhost";
        private	$dbUser = "kentenna_kt";
        private	$dbName = "kentenna_journal";
		...
		function getConnectionInfo(){
			return "Host: ".$this->dbHost."<br />Name: ".$this->dbName."<br />User: ".$this->dbUser."<br />Password: ".$this->dbPass;
		}
